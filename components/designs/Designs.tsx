...
function Designs() {
  return (
    <div className="m-10 md:m-5 grid grid-cols-1 gap-8 md:grid-cols-2 items-start">
      ...
      <img className="sqD md:min-w-[800px] bottom-[-100px] left-1/2 sm:bottom-[-150px] -translate-x-1/2 object-cover sm:min-w-[1100px]" style={{ zIndex: "-10" }} src="/static/doodles/hero/fancyLines.svg" />
    </div>
  );
}
