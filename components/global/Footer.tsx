...
function Footer() {
  return (
    <footer className="flex flex-col w-screen px-5 py-10 border-t border-fun-pink-darker z-5 bg-bg">
      <div className="gap-10 max-w-4xl m-auto grid grid-cols-2 sm:grid-cols-3 justify-between items-start">
        ...
        <p className="flex flex-col items-center justify-center ">
          <div className="inline-flex items-center uppercase text-xs font-bold tracking-widest">
            ...
            <div className="space-x-2 inline-flex items-center -mt-1 ml-3">
              ...
              <span>
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-plain.svg" width="26" title="TailwindCSS" />
