...
function Page({ currentPage, meta: { title, desc }, children }: PageProps) {
  ...
  const pageTitle = `${currentPage === "Home" ? "Marcos Miguez - App developer" : `${currentPage} - Marcos Miguez`}`;
    ...
    mounted && (
      <div className="w-full m-auto flex flex-col items-center justify-center min-h-screen opening-box-animate-paddin text-white overflow-hidden md:overflow-visible" style={{ maxWidth: "1200px" }}>
        <Head>
          ...
          <meta property="og:url" content="https://marcos-miguez.netlify.app/" />
          <meta property="og:title" content={pageTitle} />
          <meta property="og:description" content={desc} />
          <meta property="og:image" content="https://ibb.co/WxsrnJh" />

          <meta property="twitter:card" content="summary_large_image" />
          <meta property="twitter:url" content="https://marcos-miguez.netlify.app/https://marcos-miguez.netlify.app/" />
          <meta property="twitter:title" content={pageTitle} />
          <meta property="twitter:description" content={desc} />
          <meta property="twitter:image" content="https://marcos-miguez.netlify.app/"></meta>
